$begin 'Profile'
	...
	$begin 'ProfileGroup'
		...
		Name='Solution Process'
		$begin 'StartInfo'
			I(1, 'Start Time', '07/21/2026 13:02:45')
			I(1, 'Host', 'EN461007')
			I(1, 'Processor', '16')
			I(1, 'OS', 'NT 10.0')
			I(1, 'Product', 'Maxwell 3D 2023.2.0')
		...
		$begin 'ProfileGroup'
			...
			ProfileItem('Machine', 0, 0, 0, 0, 0, 'I(4, 1, \'Name\', \'EN461007.UoA.auckland.ac.nz\', 3, \'RAM Limit\', 90, \'%f%%\', 2, \'Tasks\', 1, false, 2, \'Cores\', 4, false)', false, true)
		$end 'ProfileGroup'
		ProfileItem('Design Validation', 0, 0, 0, 0, 0, 'I(3, 1, \'Level\', \'Perform full validations\', 1, \'Elapsed Time\', \'00:00:00\', 2, \'Memory\', 53128, true)', false, true)
		ProfileFootnote('I(2, 1, \'Stop Time\', \'07/21/2026 13:02:45\', 1, \'Status\', \'Normal Completion\')', 0)
	$end 'ProfileGroup'
$end 'Profile'
